...
export const fallbackFeaturedWatches = fallbackProducts
  .filter((p) => p.category === 'watches')
  .slice(0, 6)

export const fallbackFeaturedBags = fallbackProducts
  .filter((p) => p.category === 'bags')
  .slice(0, 6)

export const fallbackFeaturedJewelry = fallbackProducts
